...
def agregar_alumno(campo_clave_alumno, campo_nombre_alumno, campo_edad_alumno, campo_clave_grupo):
    ...
    if not clave_alumno or not nombre_alumno:
    ...
    if documento_existente:
        ...
        coleccion_alumnos.insert_one({"cveAlu": clave_alumno, "nomAlu": nombre_alumno})
...
def modificar_alumno(campo_clave_alumno, campo_nombre_alumno, campo_edad_alumno, campo_clave_grupo):
    ...
    resultado_modificacion = coleccion_alumnos.update_one({"cveAlu": clave_alumno}, {"$set": {"nomAlu": nombre_alumno}})
...
def eliminar_alumno(campo_clave_alumno, campo_nombre_alumno):
    clave_alumno = campo_clave_alumno.get().strip()
    if not clave_alumno:
    ...
    if resultado_eliminacion.deleted_count > 0:
        ...
        limpiar_campos_alumno(campo_clave_alumno, campo_nombre_alumno)
    else:
